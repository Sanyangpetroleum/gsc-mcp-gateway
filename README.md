...
See [ARCHITECTURE.md](ARCHITECTURE.md), [SECURITY.md](SECURITY.md), [SETUP.md](SETUP.md), [CLIENTS.md](CLIENTS.md), [AUTH_STORAGE_DECISION.md](AUTH_STORAGE_DECISION.md), and [IMPLEMENTATION_AUDIT.md](IMPLEMENTATION_AUDIT.md).
